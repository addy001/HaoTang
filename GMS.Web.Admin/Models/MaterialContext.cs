...
namespace GMS.Web.Admin.Models
{
    public class MaterialContext : DbContext
    {
        ...
        // 
        // System.Data.Entity.Database.SetInitializer(new System.Data.Entity.DropCreateDatabaseIfModelChanges<GMS.Web.Admin.Models.MaterialContext>());

        public MaterialContext() : base("name=MaterialContext")
        {
        }
