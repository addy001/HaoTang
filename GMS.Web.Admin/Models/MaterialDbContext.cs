...
namespace GMS.Web.Admin.Models
{
    public class MaterialDbContext : DbContext
    {
        ...
        // 
        // System.Data.Entity.Database.SetInitializer(new System.Data.Entity.DropCreateDatabaseIfModelChanges<GMS.Web.Admin.Models.MaterialDbContext>());

        public MaterialDbContext() : base("name=MaterialDbContext")
        {
        }
